        ...
        {!submitted ? (
          <>
            ...
            <form
              ...
              className="flex text-white bg-white/15 rounded-full shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-sm border border-white/30 p-2 pl-5 z-10 items-center"
            >
              <input
                type="email"
                placeholder="E-MAIL"
